...
const Product = ({ Products }) => {
  ...
  return (
    <div className={`shadow-1 px-3 pt-3 rounded-lg rounded-tl-[90px] w-full max-w-[352px] mx-auto cursor-pointer hover:shadow-2xl transition relative`}>
      ...
      min-w-[240px] max-w-[240px] min-h-[240px] max-h-[240px] object-cover`} src={Products?.selectedFile[0] || "https://th.bing.com/th/id/OIP.GcAC1UsSuaxHpZiZEUCbtgHaFP?rs=1&pid=ImgDetMain"} alt={Products?.title} /></center>
